        ...
        <div className="card-group">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                জামুন্না কতৃক আয়োজিত ফ্রি-ফায়ার টুর্ণামেন্ট অনুষ্ঠিত হতে যাচ্ছে
                আকর্ষণীয় পুরস্কার এর সাথে। আগ্রহীরা স্কোয়াড নিয়ে রেডি হয়ে যাও।
              </p>
            </div>
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                যারা খেলতে ইচ্ছুক তারা এই টুর্নামেন্টে অংশগ্রহন করতে পারো ।সবাই
                সুন্দর ভাবে খেলার চেষ্টা করবে এবং আমাদেরকে সুষ্ঠুভাবে খেলা
